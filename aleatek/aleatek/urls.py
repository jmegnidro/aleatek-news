...
from mission.views import AddInterventionTechnique, AddMissionActive, DeleteArticleSelectForAffaire, \
    ...
    GetAllMissionViewByChapitre, MissionAdminViewsetAdmin, MissionActiveAdminViewsetAdmin, ITAdminViewsetAdmin, \
    ...
    AllIntervenantForAffaire, AllMissionForAffaire, ArticleMissionViewsetAdmin
...
from Dashbord.views import AffaireAdminViewsetAdmin, PlanAffaireAdminViewsetAdmin, ProduitAdminViewsetAdmin, \
    ...
    GetPlanAffaireDetailForPlanAffaire, DeleteEntrepriseAffaire, CreateAffaireAndPlanAffaire
...
from RICT.views import ReviserRICT, GenerateDataForRICT, SaveDecriptionSommaire, ValidateRICT, \
    ...
    DispositionViewsetAdmin, CommentaireAvisArticleViewsetAdmin, DocumentRICTViewsetAdmin, GetDesriptionSommaireByRICT, \
    SaveArticleDisposition, GetDisposionAvisAndComment, MissionRICTViewsetAdmin, ValidateDevalidateMissionRict
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        description="Application de Controle",
        terms_of_service="https://www.aleos-controle.fr",
        contact=openapi.Contact(email="bonjour@aleoscontrole.com"),
        license=openapi.License(name="Proprietaire"),
    ),
    public=True,
...
router.register('admin/synthese_commentaire_document', SyntheseCommentaireDocumentViewsetAdmin,
...
router.register('admin/synthese_commentaire_article', SyntheseCommentaireArticleViewsetAdmin,
...
router.register('admin/commentaire_avis_article', CommentaireAvisArticleViewsetAdmin,
                basename='commentaire_avis_article')
...
urlpatterns = [
    ...
    path('api-aleatek/', schema_view.with_ui('redoc', cache_timeout=0), name='schema-redoc'),
    ...
    path('api/detail_plan_affaire_for_plan_affaire/<int:id_plan_affaire>/',
